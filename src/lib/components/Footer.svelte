...
<div class=" bg-gray-900">
    <div class="max-w-2xl mx-auto text-white py-10">
        <div class="text-center">
            <h3 class="text-3xl mb-3"> Work With Nafuna! </h3>
            <p> Get in touch with Nafuna and the studio to work with us. Our upcoming mobile application, Nafuna Avenue will be available on the following platforms</p>
            <div class="flex justify-center my-10">
                ...
                <div class="flex items-center border w-auto rounded-lg px-4 py-2 w-44 mx-2">
                    <img src="https://cdn-icons-png.flaticon.com/512/888/888841.png" class="w-7 md:w-8" alt="mage">
                    <div class="text-left ml-3">
                        <p class='text-xs text-gray-200'>Download on </p>
