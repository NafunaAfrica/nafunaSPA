<script lang="ts">
  ...
  // const { form: formData, errors, enhance, delayed, mesage } = form;
...
$: selectedBudget = $formData.Budget 
  ...
  : undefined;  
    ...
    // $: console.log('Form values in ContactForm:', $form); 


     // Add these console logs
  // $: console.log('Form values:', $form);
  // $: if ($form.Product) console.log('Product selected:', $form.Product);
  // $: if ($form.Budget) console.log('Budget selected:', $form.Budget);
</script>


<div class="flex flex-col gap-10 p-10 container mx-auto bg-muted rounded grid grid-cols-1 md:grid-cols-2">
    <h1 class="py-5 text-center text-2xl font-semibold">Contact Us</h1>
  ...
  >
      ...
      <div class="flex gap-5 ">
        ...
        <div>
          ...
          onSelectedChange={(v) => v && ($formData.Product = v.value)}
        >
  ...
  onSelectedChange={(v) => v && ($formData.Budget = v.value)}
>
                                <Select.Trigger class="w-[180px]">
